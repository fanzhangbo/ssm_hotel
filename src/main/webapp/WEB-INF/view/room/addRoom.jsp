...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="roomNo" lay-verify="required" lay-reqtext="房型号不能为空" placeholder="请输入房型号" value="" class="layui-input">
            <tip>填写房间号</tip>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">单选框</label>
        <div class="layui-input-block">
            <input type="radio" name="status" value="1" title="空房" checked="">
            <input type="radio" name="status" value="2" title="打扫">
            <input type="radio" name="status" value="3" title="维修">
            <input type="radio" name="status" value="4" title="有人">
        </div>
    </div>
