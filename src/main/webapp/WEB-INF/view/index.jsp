...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/layuimini.css?v=2.0.0" media="all">
    ...
    <div class="layui-header header">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting"><span id="unReadNum"></span>
                    <a href="javascript:;">${user.username}</a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" layuimini-content-href="/user/profile" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
        ...
        setInterval(function() {
            $.ajax({
                ...
                success: function(data) {
                    if (data.code == 1) {
                        if (data.data != 0) {
                            $("#unReadNum").html('<span class="layui-badge-dot"></span>')
                        } else {
                            $("#unReadNum").html("")
                        }
                    }
