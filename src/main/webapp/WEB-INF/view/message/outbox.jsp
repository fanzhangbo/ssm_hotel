...
<script id="rankTpl" type="text/html">
    ...
    {{# } else { }}
        <button type="button" class="layui-btn layui-btn-xs" style="background-color: #ddff84">普通</button>
    {{#  } }}
</script>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                {field: 'targetId', title: '收件人', minWidth:"120", templet:'<div>{{d.targetUser.username}}</div>'},
